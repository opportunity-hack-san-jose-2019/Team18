        ...
        if (localStorage.getItem('email') && this.state.fullname && this.state.interestedfields && this.state.subfields && this.state.mobilenumber && this.state.linkedinurl && this.state.shortdescription && this.state.goals){
            ...
            .then(response => {
                if (response.status === 200) {
                    ...
                    console.log("Student Registration successfull, data inserted");
                }
            })
            .catch((error) => {
            ...
            alert('Some details are missing in Student Registration fields')
        }
    }
                    ...
                    <div className="container">
                        <center>
                            ...
                            <form className="marginTop">
                                ...
                                <div className="myInputDiv">
                                    <input name = 'linkedinurl' className="myInput col-sm-12" type="text" onChange={this.handleChange.bind(this)} placeholder="LinkedIn Url"></input>
                                </div>
                                <div className="myInputDiv">
                                    <textarea name = 'shortdescription' className="myTextArea col-sm-12" rows="6" onChange={this.handleChange.bind(this)} placeholder="Short description about you."></textarea>
                                </div>
                                <div className="myInputDiv">
                                    <textarea name = 'goals' className="myTextArea col-sm-12" rows="6" onChange={this.handleChange.bind(this)} placeholder="Future goals and asipirations"></textarea>
                                </div>
